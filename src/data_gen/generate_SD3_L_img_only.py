...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate SD3-L images and save intermediate PCA features."
    )
    parser.add_argument(
        "--start",
        type=float,
    ...
    parser.add_argument(
        ...
        help="Path to Stable Diffusion 3.5 Large checkpoint.",
    )
    parser.add_argument(
        "--prompt-path",
        type=str,
...
def main() -> None:
    ...
    if args.save_path is None:
        save_path = (
            ...
            f"SD3_L_cocotrain_fullcap-numimgs_alltime_perprompt{args.num_imgs_per_prompt}_pca48_imgcaponly"
        )
    else:
